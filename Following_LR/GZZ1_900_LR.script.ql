// 11.10.2021 8:34:26 GZZ1_900_LR_7600yup ql script
// Created 11.10.2021 8:34:26
...
reporter(start_time, end_time) := 
{
	...
	log("step_=;" + step 
		...
		+ ";llow.slope_=;" + ind("LinearRegression", "slope", "low", predict_window_support, "low", train_window_support)
		+ ";llow.mae_=;" + ind("LinearRegression", "mae", "low", predict_window_support, "low", train_window_support)*/
