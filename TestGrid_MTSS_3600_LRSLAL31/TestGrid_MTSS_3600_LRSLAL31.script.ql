// 27.12.2024 10:00:47 TestGrid_MTSS_3600_LRSLAL31 ql script
// Created 27.12.2024 10:00:47
...
script_to_test = "LR_strategy_SlopeLevel_AdaptiveLots (33-my_stop_nextTS-in-opening).aql";
...
my_param["value"] = 0.1n;//iter(1.2n, 1.2n, 2n);
