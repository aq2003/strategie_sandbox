// 19.12.2025 21:15:21 TestGrid_RIH6_3600_LRSLAL33 ql script
// Created 19.12.2025 21:15:21

// 21.06.2025 13:58:05 TestGrid_RIU5_3600_LRSLAL33 ql script
// Created 21.06.2025 13:58:05

// 07.06.2025 14:16:06 TestGrid_RIM5_3600_LRSLAL33 ql script
// Created 07.06.2025 14:16:06
...
my_param["value"] = (close * 0.01% / 1p);//0n;//iter(0n, 40n, 10n);
...
my_param["value"] = -325n;//iter(-6n, -6n, 2n);
...
// +++ 2nd turn ---------------------------------------------------------------------------------------------------------------------------------
{
	...
	// 14
	(params[i_train_window_slow_period])["value"] = iter(300c, 1000c/*2000c*/, 5c);
