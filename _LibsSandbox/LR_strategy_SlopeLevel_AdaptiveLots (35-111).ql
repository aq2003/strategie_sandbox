...
) :=
{
	...
	||
		..{
			...
			my_slope_long = abs(ind("LinearRegression", "slope", "low", predict_window, low_offset, train_window)[-1c]);
		...
		&&
			...
			my_slope_short = abs(ind("LinearRegression", "slope", "high", predict_window, low_offset, train_window)[-1c]);
