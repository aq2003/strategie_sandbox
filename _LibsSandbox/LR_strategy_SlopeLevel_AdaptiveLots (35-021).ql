...
) :=
{
	...
	current_slope_long = ind("LinearRegression", "slope", "high"/*longTS_price_type*/, "once", "low"/*longTS_price_type*//*longTS_offset_type*/, candle.time[nextTSlong_index - 2c], candle.time[-1c]);
	...
	||
		...
		current_nextTSlong = ind("LinearRegression", "low"/*longTS_line*/, "high"/*longTS_price_type*/, "once", "low"/*longTS_price_type*//*longTS_offset_type*/, candle.time[nextTSlong_index-2c], candle.time[-1c]);
...
) :=
{
	...
	current_slope_short = ind("LinearRegression", "slope", "low"/*shortTS_price_type*/, "once", "high"/*shortTS_price_type*//*shortTS_offset_type*/, candle.time[nextTSshort_index - 2c], candle.time[-1c]);
	...
	||
		...
		current_nextTSshort = ind("LinearRegression", "high"/*shortTS_line*/, "low"/*shortTS_price_type*/, "once", "high"/*shortTS_price_type*//*shortTS_offset_type*/, candle.time[nextTSshort_index-2c], candle.time[-1c]);
		slope_type = "calculated_slope";
	};
...
// 4.03.2026
LR_strategy_long_condition_SlopeLevel_AdaptiveLots_3502(
...
// 4.03.2026
LR_strategy_short_condition_SlopeLevel_AdaptiveLots_3502(
	expiration_time, 	// Time when to stop the strategy
...
LR_strategy_long_SlopeLevel_AdaptiveLots_3502(
...
LR_strategy_short_SlopeLevel_AdaptiveLots_3502(
	p_safety_stock,	// Safety stock in percents to the equity
