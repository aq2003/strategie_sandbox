...
) :=
{
	...
	predict_window_support = params[ipredict_window_support];	// Support line predict window type := ("week" || "day" || "candle")
	train_window_support = params[itrain_window_support];		// Support line width of training window in candle number
