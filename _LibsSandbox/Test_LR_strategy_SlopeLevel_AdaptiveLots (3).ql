...
) :=
{
	...
	LR_strategy_SlopeLevel_library = "%QTrader_Libs%\LR_strategy_SlopeLevel_AdaptiveLots (3).aql";
	...
	current_no_activity = no_activity_start;
	..[current_no_activity <= no_activity_stop] 
	{
		current_no_activity += no_activity_step;
		count4 += 1i
	};
	...
	current_slope_long_level = slope_long_level_start;
	..[current_slope_long_level <= slope_long_level_stop] 
	{
		current_slope_long_level += slope_long_level_step;
		count3 += 1i
	};
	// --- Checking parameter steps and calculating count of turns - count3
	...
	count2 = 0i;
	{
		slope_long_stop / slope_long_step << slope_long_step == 0n;
		log("parameter_step_<slope_long_step>_cannot_be_zero");
	||
		slope_long_step = slope_long_step << slope_long_step != 0n
	};
	current_slope_long = slope_long_start;
	..[current_slope_long <= slope_long_stop] 
	{
		current_slope_long += slope_long_step;
		count2 += 1i
	};
	// --- Checking parameter steps and calculating count of turns - count2
	...
	current_train_window_support = train_window_support_start;
	..[current_train_window_support <= train_window_support_stop] 
	{
		current_train_window_support += train_window_support_step;
		count1 += 1i
	};
	// --- Checking parameter steps and calculating count of turns - count1
	...
	current_train_window = train_window_start;
	..[current_train_window <= train_window_stop] 
	{
		current_train_window += train_window_step;
		count += 1i
	};
	// --- Checking parameter steps and calculating count of turns - count
	...
	current_slope_long = slope_long_start;
	current_slope_short = slope_short_start;
	current_channel_width = channel_width_start;
	...
	count3 = 0i;
	current_slope_long_level = slope_long_level_start;
	//current_slope_short_level = slope_short_level_start;
	current_slope_short_level = -current_slope_long_level;
	..[current_slope_long_level <= slope_long_level_stop]
	{ // count3
		// +++ slope_long loop
		...
		current_slope_long = slope_long_start;
		//current_slope_short = slope_short_start;
		current_slope_short = -current_slope_long;
		..[current_slope_long <= slope_long_stop]
		{
			...
			{
				// +++ train_window loop
				current_train_window_resistance = current_train_window_support;
				...
				..[current_train_window <= train_window_stop]
				{
					...
					+ ";train_window=;" + current_train_window + ";train_window_support=;" + current_train_window_support 
					+ ";current_slope_long=;" + current_slope_long + ";current_slope_short=;" + current_slope_short + ";slope_long_start=;" + slope_long_start + ";slope_short_start=;" + slope_short_start
					+ ";slope_long_level=;" + current_slope_long_level + ";slope_short_level=;" + current_slope_short_level 
					+ ";current_channel_width=;" + current_channel_width
					+ ";current_no_activity=;" + current_no_activity
					);
					...
					..[candles.is_calculated != 1n] 
					{
						...
						LR_strategy_SlopeLevel_AdaptiveLots(
							...
							current_slope_long, current_slope_short,
							current_slope_long_level, current_slope_short_level,
							predict_window_support, 
							current_train_window_support,
							predict_window_resistance, 
							current_train_window_resistance,
	...
	
					{
						...
						best_train_window = current_train_window;
						best_train_window_support = current_train_window_support;
						best_slope_long = current_slope_long;
						best_slope_short = current_slope_short;
						best_slope_long_level = current_slope_long_level;
						best_slope_short_level = current_slope_short_level;
						best_channel_width = current_channel_width;
						best_no_activity = current_no_activity;
					...
					+ ";current_slope_long=;" + current_slope_long + ";current_slope_short=;" + current_slope_short 
				...
				current_train_window_support += train_window_support_step;
				current_train_window_resistance += train_window_resistance_step;
				count1 += 1i;
			};
			// --- train_window_support loop
	...
	system.log("Test_LR_strategy_SlopeLevel_AdaptiveLots(3)_stopped;count=;" + count3 + "." + count2 + "." + count1 + "." + count 
			+ ";equity=;" + equity + ";account=;" + account 
			+ ";best_equity=;" + best_equity 
			+ ";best_max_equity=;" + best_max_equity
			+ ";best_min_equity=;" + best_min_equity
