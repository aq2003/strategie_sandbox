// 19.12.2025 21:17:28 TestGrid_CRH6_3600_LRSLAL33 ql script
// Created 19.12.2025 21:17:28

// 21.06.2025 14:04:26 TestGrid_CRU5_3600_LRSLAL33 ql script
// Created 21.06.2025 14:04:26

// 23.03.2025 9:21:20 TestGrid_CRM5_3600_LRSLAL33 ql script
// Created 23.03.2025 9:21:20
...
my_param["value"] = slope_start_init;//0.01%;//0.0026n;//iter(0n, 0.0052n, 0.0013n);
...
my_param["value"] = -14n;//-0.013n;//iter(-6n, -6n, 2n);
...
// +++ 3rd turn ---------------------------------------------------------------------------------------------------------------------------------
{
	...
	slope_long_max *= 4n;
	//slope_long_max = (close * 0.1% / 1p);//0.1%;//(close * 0.1% / 1p);//
	...
	slope_short_min *= 4n;
	//slope_short_min = (-close * 0.1% / 1p);//-0.1%;//
