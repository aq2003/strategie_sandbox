// 10.12.2024 14:12:28 TestGrid_MGNT_AFKS_LRSLAL33 ql script
// Created 10.12.2024 14:12:28
...
//my_param["name"] = "slope_long";
//my_param["value"] = 0.01n;//iter(1.2n, 1.2n, 2n);
(params[i_slope_long])["value"] = iter(0n, 0.05n, 0.005n);
...
//my_param["name"] = "slope_short";
//my_param["value"] = -0.01n;//iter(-1.2n, -1.2n, -2n);
(params[i_slope_short])["value"] = iter(0n, -0.05n, -0.005n);
