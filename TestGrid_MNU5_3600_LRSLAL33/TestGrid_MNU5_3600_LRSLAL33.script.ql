// 21.06.2025 10:59:16 TestGrid_MNU5_3600_LRSLAL33 ql script
// Created 21.06.2025 10:59:16

// 15.06.2025 13:23:07 TestGrid_MNM5_3600_LRSLAL33 ql script
// Created 15.06.2025 13:23:07
...
my_param["value"] = -8n;//iter(-6n, -6n, 2n);

// 19
i_slope_short_level = count(params);
params += (my_param = new("dict"));
my_param["name"] = "slope_short_level";
my_param["value"] = 12n;//iter(6n, 6n, 2n);
