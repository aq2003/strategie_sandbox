...
long_close_price1_start = 5p; // Start <Price delta to the long position open price to make the take profit stop>
long_close_price1_stop = 25p; // Stop <Price delta to the long position open price to make the take profit stop>
long_close_price1_step = 5p; // Step <Price delta to the long position open price to make the take profit stop>

long_close_price2_start = 5p; // Start <Price delta to the long position open price to make the take profit stop>
long_close_price2_stop = 25p; // Stop <Price delta to the long position open price to make the take profit stop>
long_close_price2_step = 5p; // Step <Price delta to the long position open price to make the take profit stop>

short_close_price1_start = 5p; // Start <Price delta to the short position open price to make the take profit stop>
short_close_price1_stop = 25p; // Stop <Price delta to the short position open price to make the take profit stop>
short_close_price1_step = 5p; // Step <Price delta to the short position open price to make the take profit stop>

short_close_price2_start = 5p; // Start <Price delta to the short position open price to make the take profit stop>
short_close_price2_stop = 25p; // Stop <Price delta to the short position open price to make the take profit stop>
short_close_price2_step = 5p; // Step <Price delta to the short position open price to make the take profit stop>

long_stop_loss_start = 25p; // Start <Long position stop loss level relatively to the position open price>
long_stop_loss_stop = 50p; // Stop <Long position stop loss level relatively to the position open price>
long_stop_loss_step = 5p; // Step <Long position stop loss level relatively to the position open price>

short_stop_loss_start = 25p; // Start <Short position stop loss level relatively to the position open price>
short_stop_loss_stop = 50p; // Stop <Short position stop loss level relatively to the position open price>
short_stop_loss_step = 5p; // Step <Short position stop loss level relatively to the position open price>
