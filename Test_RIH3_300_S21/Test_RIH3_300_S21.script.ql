// 24.02.2023 21:34:54 Test_RIH3_300_S21 ql script
// Created 24.02.2023 21:34:54

// 23.02.2023 21:21:18 Test_GZH3_300_S21 ql script
// Created 23.02.2023 21:21:18
...
long_close_price1_start = 0.4%; // Start <Price delta to the long position open price to make the take profit stop>
long_close_price1_stop = 0.4%; // Stop <Price delta to the long position open price to make the take profit stop>
long_close_price1_step = 0.1%; // Step <Price delta to the long position open price to make the take profit stop>

long_close_price2_start = 0.5%; // Start <Price delta to the long position open price to make the take profit stop>
long_close_price2_stop = 1%; // Stop <Price delta to the long position open price to make the take profit stop>
long_close_price2_step = 0.1%; // Step <Price delta to the long position open price to make the take profit stop>

short_close_price1_start = 0.3%; // Start <Price delta to the short position open price to make the take profit stop>
short_close_price1_stop = 0.3%; // Stop <Price delta to the short position open price to make the take profit stop>
short_close_price1_step = 0.1%; // Step <Price delta to the short position open price to make the take profit stop>

short_close_price2_start = 1%; // Start <Price delta to the short position open price to make the take profit stop>
short_close_price2_stop = 1%; // Stop <Price delta to the short position open price to make the take profit stop>
short_close_price2_step = 0.1%; // Step <Price delta to the short position open price to make the take profit stop>

long_stop_loss_start = 0.2%; // Start <Long position stop loss level relatively to the position open price>
long_stop_loss_stop = 1%; // Stop <Long position stop loss level relatively to the position open price>
long_stop_loss_step = 0.2%; // Step <Long position stop loss level relatively to the position open price>

short_stop_loss_start = 0.6%; // Start <Short position stop loss level relatively to the position open price>
short_stop_loss_stop = 1%; // Stop <Short position stop loss level relatively to the position open price>
