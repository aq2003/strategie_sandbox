// 16.03.2024 14:08:20 Test_RASP_3600_LR ql script
// Created 16.03.2024 14:08:20
...
risk_S = 18%;		// Risk rate in percents for short positions
...
slope_long_level_start = -0.3n;
slope_long_level_stop = 0n;
slope_long_level_step = 0.03n;
slope_short_level_start = 0n;
slope_short_level_stop = 0.3n;
slope_short_level_step = 0.03n;
