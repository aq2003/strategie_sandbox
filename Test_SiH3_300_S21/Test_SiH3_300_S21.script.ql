// 24.02.2023 14:26:50 Test_SiH3_300_S21 ql script
// Created 24.02.2023 14:26:50
...
long_close_price1_stop = 0.5%; // Stop <Price delta to the long position open price to make the take profit stop>
...
long_close_price2_stop = 0.5%; // Stop <Price delta to the long position open price to make the take profit stop>
long_close_price2_step = 0.1%; // Step <Price delta to the long position open price to make the take profit stop>

short_close_price1_start = 0.1%; // Start <Price delta to the short position open price to make the take profit stop>
...
short_close_price2_start = 0.1%; // Start <Price delta to the short position open price to make the take profit stop>
...
long_stop_loss_stop = 0.2%; // Stop <Long position stop loss level relatively to the position open price>
long_stop_loss_step = 0.2%; // Step <Long position stop loss level relatively to the position open price>

short_stop_loss_start = 0.2%; // Start <Short position stop loss level relatively to the position open price>
short_stop_loss_stop = 0.2%; // Stop <Short position stop loss level relatively to the position open price>
