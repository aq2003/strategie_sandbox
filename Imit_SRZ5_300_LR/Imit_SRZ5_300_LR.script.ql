// 05.12.2025 20:09:10 Imit_SRZ5_300_LR ql script
// Created 05.12.2025 20:09:10

// 28.11.2025 20:03:04 Imit_GLZ5_3600_LR ql script
// Created 28.11.2025 20:03:04
...
// 	05.12.2025 16:31	TestGrid_SRU5_3600_LRSLAL33.79	Warning	#Test_stopped, , equity=100 000,00p, account=0l, best_equity=5 549 232,00p, best_max_equity=17 229 946,00p, best_min_equity=96 929,00p, mean_equity=4 323 026,79p, safety_stock, =5%, risk_L, =100%, risk_S, =100%, expiration_time, =15:00_20.12.25, day_start_time, =09:00_30.07.25, day_end_time, =19:00_30.07.25, night_start_time, =19:10_30.07.25, night_end_time, =23:49_30.07.25, predict_window_type, =candle, high_offset_type, =none, low_offset_type, =none, predict_window_slow_type, =week, train_window_slow_period, =820c, train_window_period, =40c, slope_long, =12n, slope_short, =-2,4n, slope_long_level, =-60n, slope_short_level, =60n, channel_width, =0,00p, no_activity, =-1c

expiration_time = 15:00_21.12.25;

//	29.11.2025 10:00	TestGrid_GZU5_3600_LRSLAL33.80	Warning	#test_history_completed, count=1i*1i*1i*1i*1i*1i*1i*1i*1i*1i*1i*1i*1i*79i*1i*1i*1i*1i*1i*1i*=79i_of_291i, 
// equity=115 477,00p, account=0l, best_equity=158 977,00p, best_max_equity=181 852,00p, best_min_equity=84 677,00p, 
// safety_stock, =5%, risk_L, =100%, risk_S, =100%, 
// expiration_time, =15:00_20.12.25, 
// day_start_time, =09:00_30.07.25, day_end_time, =19:00_30.07.25, night_start_time, =19:10_30.07.25, night_end_time, =23:49_30.07.25, 
// predict_window_type, =candle, high_offset_type, =none, low_offset_type, =none, 
// predict_window_slow_type, =week, train_window_slow_period, =800c, train_window_period, =18c, 
// slope_long, =13n, slope_short, =-10n, slope_long_level, =-65n, slope_short_level, =50n, channel_width, =0,00p, no_activity, =-1c, 
// seconds_spent=42,23206n
...
slope_long_start = 12n;
slope_short_start = -2.4n;
slope_long_level = -60n;
slope_short_level = 60n;

predict_window_support = "week";
train_window_support = 820c;
predict_window_resistance = "week";
train_window_resistance = 820c;
