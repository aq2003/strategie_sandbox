...
slope_long_start = (close * 0.00372% / 1p);//0.002916n;
slope_short_start = -(close * 0.00372% / 1p);//-0.002916n;
slope_long_level = -20n;
slope_short_level = 20n;

predict_window_support = "candle";
train_window_support = (train_window * 2n);
predict_window_resistance = "candle";
train_window_resistance = (train_window * 2n);
...
import("%QTrader_Libs%\LR_strategy_SlopeLevel_AdaptiveLots (35-5).aql");
