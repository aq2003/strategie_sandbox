// 11.12.2022 17:01:10 MLM2_900_LR2 ql script
// Created 11.12.2022 17:01:10
...
slow_predict_window = "candle"; 
slow_train_window = 300c;
slow_high_offset = "none";
slow_low_offset = "none";
...
LR_strategy2(
			...
			slow_predict_window, slow_train_window,
			slow_high_offset, slow_low_offset,
