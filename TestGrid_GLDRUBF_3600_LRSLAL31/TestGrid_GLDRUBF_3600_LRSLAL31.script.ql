// 06.02.2026 21:46:50 TestGrid_GLDRUBF_3600_LRSLAL31 ql script
// Created 06.02.2026 21:46:50

// 18.01.2026 14:22:02 TestGrid_IMOEXF_3600_LRSLAL31 ql script
// Created 18.01.2026 14:22:02

// 17.12.2025 20:53:05 TestGrid_IMOEXF_300_LRSLAL33 ql script
// Created 17.12.2025 20:53:05
...
my_param["value"] = (close * 0.001% / 1p);//0.05n;//iter(1.2n, 1.2n, 2n);
...
// +++ 2nd turn ---------------------------------------------------------------------------------------------------------------------------------
{
	...
	// 14
	(params[i_train_window_slow_period])["value"] = iter(300c, 1500c, 5c);
