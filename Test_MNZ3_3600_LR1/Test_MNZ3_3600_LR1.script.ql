...
log("slope_long_level_start_=;" + slope_long_level_start);
log("slope_long_level_stop_=;" + slope_long_level_stop);
log("slope_long_level_step_=;" + slope_long_level_step);
log("slope_short_level_start_=;" + slope_short_level_start);
log("slope_short_level_stop_=;" + slope_short_level_stop);
log("slope_short_level_step_=;" + slope_short_level_step);
...
..[my_slope_long_level <= slope_long_level_stop]
{
	...
	..[my_slope_long <= slope_long_stop]
	{
		...
		my_slope_long += slope_long_step;
		my_slope_short += slope_short_step;
		count2 += 1i;
	};
	// --- slope_long loop
