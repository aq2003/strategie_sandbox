// 08.06.2022 10:11:28 Test_YNM2_900_LR ql script
// Created 08.06.2022 10:11:28
...
train_window_support = 200c;
predict_window_resistance = "week";
train_window_resistance = 200c;
...
..[my_slope_long_start < 30n]
{
	...
	count1 = 0i;
	..[my_train_window_support <= 1000c]
	{
		my_train_window = train_window;
		
		count = 0i;
		..[my_train_window <= 160c]
		{
