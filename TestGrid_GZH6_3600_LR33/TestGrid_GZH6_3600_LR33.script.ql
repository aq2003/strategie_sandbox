// 22.02.2026 16:15:15 TestGrid_GZH6_3600_LR33 ql script
// Created 22.02.2026 16:15:15

// 20.12.2025 9:40:42 TestGrid_GZH6_3600_LRSLAL33 ql script
// Created 20.12.2025 9:40:42

// 21.06.2025 13:56:12 TestGrid_GZU5_3600_LRSLAL33 ql script
// Created 21.06.2025 13:56:12

// 07.06.2025 14:19:14 TestGrid_GZM5_3600_LRSLAL33 ql script
// Created 07.06.2025 14:19:14
...
//test_start_time = 10:00_20.12.25;
//log("Awaiting_test_start_time=;" + test_start_time);
//log("There_is_test_start_time_expired;test_started") << system.time > test_start_time;

import("%QTrader_Libs%\QTrader_stdlib.aql");

script_to_test = "LR_strategy_SlopeLevel_AdaptiveLots (35-01).aql";
...
slope_start_init = (close * 0.01% / 1p);
